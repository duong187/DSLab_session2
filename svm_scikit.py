...
#tính các giá trị tf-idf của các đoạn văn bản ở data_path, ghi vào data_path_2
...
def classifying_with_linear_SVMs():
    train_X,train_Y=load_data('D:/Python/machine_learning/dslab_session_2/20news-train-tfidf.txt')
    ...
    test_X,test_Y=load_data('D:/Python/machine_learning/dslab_session_2/20news-test-tfidf.txt')
    predicted_y=classifier.predict(test_X)
    accuracy=compute_accuracy(predicted_y=predicted_y,expected_y=test_Y)
    print("Accuracy Linear SVMs:",accuracy)

def classifying_with_kernel_SVMs(_kernel = 'rbf'):
    train_X,train_Y=load_data('D:/Python/machine_learning/dslab_session_2/20news-train-tfidf.txt')
...
def compute_accuracy(predicted_y,expected_y):
    ...
    for i in range(expected_y.size):
        if(predicted_y[i]==expected_y[i]):
            match+=1
    accuracy=match/expected_y.size
    return accuracy

if __name__ == '__main__':
    get_tf_idf('D:/Python/machine_learning/dslab_session_2/20news-bydate-train-procceed.txt','D:/Python/machine_learning/dslab_session_2/20news-train-tfidf.txt')
    get_tf_idf('D:/Python/machine_learning/dslab_session_2/20news-bydate-test-procceed.txt','D:/Python/machine_learning/dslab_session_2/20news-test-tfidf.txt')
